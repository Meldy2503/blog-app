...
const LiteEditor: React.FC = () => {
  ...
  async function handleAddSave(
    ...
    if (!isSave && missingFields.length > 0) {
      const missingFieldNames = missingFields.join(", ");
      ErrorToast(`Please include post ${missingFieldNames}`);
    } else {
      await addSavePost(
        {
        ...
        <Box>
          ...
          <Wrapper>
            ...
            >
              ...
              >
                <Icon as={BsArrowLeftSquare} boxSize={"1.5rem"} />
              </Box>
            ...
            <form>
              ...
              >
                ...
                <Flex justify={"space-between"} my="1.5rem">
                  <Box>
                    <Input
                      type="file"
                      accept="image/*"
              ...
              <MdEditor
                style={{ height: "500px" }}
                placeholder="Compose your post using Markdown formatting to add headings, bold text, underlines, and more as displayed on the editor menu above...."
